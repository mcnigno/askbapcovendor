...
class PendingView(ModelView):
    ...
    base_filters = [['oldcode', FilterStartsWith, 'empty'],
                    ['docrequests.request_type', FilterStartsWith, 'vendor'],
...
class SuperDocumentView(CompactCRUDMixin, ModelView):
    ...
    base_filters = [['docrequests.request_type', FilterStartsWith, 'vendor']]
...
class UnitView(CompactCRUDMixin, ModelView):
    ...
    list_columns = ['unit', 'name', 'unit_type', 'description', 'start', 'stop']
...
class DocumentView(CompactCRUDMixin, ModelView):
    page_size = 25
    datamodel = SQLAInterface(Document)
    list_title = 'Bapco Vendor Codes'
    related_views = [CommentsView]
    
    
    base_order = ('id', 'desc')
    base_filters = [['created_by', FilterEqualFunction, get_user],['docrequests.request_type',FilterEqual,'Vendor']]
    base_permissions = ['can_list', 'can_show', 'can_edit'] 
...
class SuperListRequest(ModelView):
    ...
    base_filters = [['request_type', FilterEqual,'Vendor']]
